...
Different strategies are currently supported, such as the common mean, median, and mode scores.
...
## Getting started
If you are just getting started with **sigscores** we recommend starting with [Getting Started](articles/sigscores.html) section of the site.
<!-- `vignette("sigscores")` -->
