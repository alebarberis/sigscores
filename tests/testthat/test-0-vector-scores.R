...
test_that("Summary Score functions works with length 1 vector", {
  ...
  expect_equal(          bristowScore(x = v1), 0)
  expect_equal(  reviewedBristowScore(x = v1), 0)
...
test_that("Summary Score functions works with length 2 vector", {
  ...
  expect_equal(          bristowScore(x = v2), 0)
  expect_equal(  reviewedBristowScore(x = v2), 0)
...
test_that("Summary Score functions works with length 3 vector", {
  ...
  expect_equal(          bristowScore(x = v3), 0)
  expect_equal(  reviewedBristowScore(x = v3), 0)
...
test_that("Summary Score functions works with length 4 vector", {
  ...
  expect_equal(          bristowScore(x = v4), 0)
  expect_equal(  reviewedBristowScore(x = v4), 0)
...
test_that("Summary Score functions works with length 5 vector", {
  ...
  expect_equal(          bristowScore(x = v5), -1)
  expect_equal(  reviewedBristowScore(x = v5), -0.2)
...
test_that("Summary Score functions works with length 6 vector of equal elements", {
  ...
  expect_equal(          bristowScore(x = v6), 0)
  expect_equal(  reviewedBristowScore(x = v6), 0)
...
test_that("Summary Score functions works with length 2 vector of zeros", {
  ...
  expect_equal(          bristowScore(x = z2), 0)
  expect_equal(  reviewedBristowScore(x = z2), 0)
...
test_that("Summary Score functions works with length 6 vector of zeros", {
  ...
  expect_equal(          bristowScore(x = z6), 0)
  expect_equal(  reviewedBristowScore(x = z6), 0)
...
test_that("Summary Score functions works with length 6 vector of NAs (`na.rm = TRUE`)", {
  ...
  # expect_equal(          bristowScore(x = na6), 0)
  # expect_equal(  reviewedBristowScore(x = na6), 0)
  ...
  expect_equal(          bristowScore(x = na6), getDefaultNaValue())
  expect_equal(  reviewedBristowScore(x = na6), getDefaultNaValue())
...
test_that("Summary Score functions works with length 6 vector of NAs (`na.rm = FALSE`)", {
  ...
  # expect_equal(          bristowScore(x = na6, na.rm = FALSE), 0)
  # expect_equal(  reviewedBristowScore(x = na6, na.rm = FALSE), 0)
  ...
  expect_equal(          bristowScore(x = na6, na.rm = FALSE), getDefaultNaValue())
  expect_equal(  reviewedBristowScore(x = na6, na.rm = FALSE), getDefaultNaValue())
...
test_that("Summary Score functions works with length 5 vector of 3 real numbers and 2 NAs (`na.rm = TRUE`)", {
  ...
  expect_equal(          bristowScore(x = m5, na.rm = TRUE), 0)
  expect_equal(  reviewedBristowScore(x = m5, na.rm = TRUE), 0)
...
test_that("Summary Score functions works with length 5 vector of 3 real numbers and 2 NAs (`na.rm = FALSE`)", {
  ...
  expect_equal(          bristowScore(x = m5, na.rm = FALSE), 0)
  expect_equal(  reviewedBristowScore(x = m5, na.rm = FALSE), 0)
