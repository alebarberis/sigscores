...
#   expect_equal(         sumScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal( weightedSumScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(        meanScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal( trimmedMeanScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(weightedMeanScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(      medianScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(        modeScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(    midrangeScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(    midhingeScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(     trimeanScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(         iqrScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(         iqmScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(         madScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(         aadScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(      ssgseaScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(        gsvaScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(       plageScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
#   expect_equal(      zscoreScorer(x = na6, i = i6), rep(getDefaultNaValue() ,2))
# })
#
# test_that("Summary Scores functions works with 6-by-2 matrix of NAs (`na.rm = FALSE`) and signature with 6 matching elements", {
#   expect_equal(            sumScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(    weightedSumScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(           meanScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(    trimmedMeanScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(   weightedMeanScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(         medianScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(           modeScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(       midrangeScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(       midhingeScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(        trimeanScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(            iqrScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(            iqmScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(            madScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(            aadScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(         ssgseaScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(           gsvaScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(          plageScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
#   expect_equal(         zscoreScorer(x = na6, i = i6, na.rm = FALSE), rep(getDefaultNaValue() ,2))
# })
